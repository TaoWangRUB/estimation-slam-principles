...
That product **is** the factor graph of Chapter 4. Every SLAM system is an approximation to this posterior; the taxonomy below is just different approximation strategies.
